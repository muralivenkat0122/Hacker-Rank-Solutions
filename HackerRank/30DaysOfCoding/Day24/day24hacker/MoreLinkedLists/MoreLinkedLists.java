...
Input Format
	...
	handled by the locked stub code and passed to the removeDuplicates 
	function: 
	
	1. The first line contains an integer, N, the number of nodes to be 
		inserted. 
	2. The N subsequent lines each contain an integer describing the data 
...
Explanation
	...
	both occur twice in the list, so we remove the two duplicate nodes. We 
	then return our updated (ascending) list, which is {1,2,3,4}.
============================================================================
	
 */
package day24hacker.MoreLinkedLists;
