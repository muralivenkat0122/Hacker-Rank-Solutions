...
Explanation
	...
	Values in the tuple (20,20,23) form an Isosceles triangle, because A = B OR B = C or 
	C = A. 
	Values in the tuple (20,20,20) form an Equilateral triangle, because A = B AND 
	B = C. 
