...
Input Format
	...
	1. The first line contains an integer, T, the number of test cases. 
 	2. T subsequent lines each contain an integer, N, denoting the number of 
...
There are 3 test cases.
	...
	In the first case (N = 0), the initial height (H = 1) of the tree 
	remains unchanged.
	...
	(H = 6), and grows another meter after summer (H = 7). Thus, at the end 
	of 4 cycles, its height is  meters.
==============================================================================
